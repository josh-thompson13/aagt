  ...
  [874],
  {
    2664: (e, t, r) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
        Object.defineProperty(t, 'isLocalURL', { enumerable: !0, get: () => u });
      const n = r(9991),
        o = r(7102);
      function u(e) {
    ...
    2757: (e, t, r) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        })(t, { formatUrl: () => u, formatWithValidation: () => a, urlObjectKeys: () => i });
      const n = r(6966)._(r(8859)),
      ...
      function u(e) {
        ...
        (t = t ? encodeURIComponent(t).replace(/%3A/i, ':') + '@' : ''),
          e.host
            ? (f = t + e.host)
            : r && ((f = t + (~r.indexOf(':') ? '[' + r + ']' : r)), e.port && (f += ':' + e.port)),
    ...
    3180: (e, t) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
        Object.defineProperty(t, 'errorOnce', { enumerable: !0, get: () => r });
      const r = (e) => {};
    },
    6654: (e, t, r) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
        Object.defineProperty(t, 'useMergedRef', { enumerable: !0, get: () => o });
      const n = r(2115);
      function o(e, t) {
    ...
    6874: (e, t, r) => {
      ...
      function g(e) {
        ...
        const k = u.default.useContext(a.AppRouterContext),
          I = !1 !== E,
          w = null === E ? l.PrefetchKind.AUTO : l.PrefetchKind.FULL,
          { href: D, as: F } = u.default.useMemo(() => {
            const e = y(P);
            return { href: e, as: _ ? y(_) : e };
          }, [P, _]);
        L && (r = u.default.Children.only(t));
        const K = L ? r && 'object' == typeof r && r.ref : M,
          B = u.default.useCallback(
            (e) => (
              null !== k && (b.current = (0, p.mountLinkInstance)(e, D, k, w, I, g)),
              () => {
                b.current &&
        ...
        return (
          (0, c.isAbsoluteUrl)(F)
            ? (z.href = F)
            : (L && !O && ('a' !== r.type || 'href' in r.props)) ||
              (z.href = (0, s.addBasePath)(F)),
          (n = L ? u.default.cloneElement(r, z) : (0, o.jsx)('a', { ...R, ...z, children: t })),
          (0, o.jsx)(m.Provider, { value: i, children: n })
        );
      }
      r(3180);
      const m = (0, u.createContext)(p.IDLE_LINK_STATUS),
        b = () => (0, u.useContext)(m);
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
    ...
    9991: (e, t) => {
      ...
      const p = 'undefined' != typeof performance,
        d =
          p &&
