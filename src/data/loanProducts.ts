...
export const loanProducts: LoanProduct[] = [
  {
    ...
    seoDescription:
      'Get fast business expansion loans from $150k to $10M. Same-day approval, 4-day settlement. Competitive rates from 7.95%. Apply now for business growth funding.',
    seoKeywords: [
  ...
  
  {
    ...
    seoDescription:
      'Bridging finance from $150k to $10M. 24-hour approval, 4-day settlement. Perfect for auctions and quick property transactions.',
    seoKeywords: [
      'bridging finance',
      'bridge loans',
      'auction finance',
