...
export const metadata: Metadata = {
  ...
  description: 'Find answers to common questions about private lending, loan applications, rates, fees, and more. Get expert answers from Australia\'s leading private lender.',
  keywords: 'private lending FAQ, business loan questions, loan application help, private lender questions, lending advice Australia',
  openGraph: {
    title: 'FAQ - Your Private Lending Questions Answered | AAGT Private Loans',
    description: 'Get instant answers to your private lending questions. Comprehensive FAQ covering rates, applications, eligibility, and more from Australia\'s trusted private lender.',
    type: 'website',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Get answers to your private lending questions. Expert advice from Australia\'s leading private lender.',
...
export default function FAQPage() {
  ...
  const organizationSchema = {
    ...
    'description': 'Leading Australian private lender providing expert answers and support for business and investment lending',
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-primary-100 mb-8">
                Get instant answers to your private lending questions from Australia's leading specialists
              </p>
        ...
        <section className="bg-primary-900 text-white py-16">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Our lending specialists are here to help with personalized answers to your specific questions
            </p>
