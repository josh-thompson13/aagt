...
import { ArrowRight, CheckCircle2, Calculator, TrendingDown, Clock, FileText, Shield, DollarSign } from 'lucide-react';

export async function generateMetadata() {
  return {
    title: 'Rates & Terms | Competitive Private Loan Rates',
    description: 'Transparent private loan rates and terms. Compare our competitive interest rates with major banks. Flexible terms from 1-24 months.',
    keywords: 'private loan rates Australia, business loan interest rates, competitive loan terms, private lending rates, loan comparison',
    alternates: {
...
export default function RatesTermsPage() {
  ...
  const loanTypes = [
    {
      ...
      features: ['Same day approval', 'Minimal documentation', 'Any business purpose', 'Fast settlement']
    },
    {
    ...
    },
    {
      ...
      features: ['Quick settlements', 'Temporary funding', 'Property bridging', 'Cash flow solutions']
    },
    {
  ...
  const bankComparison = [
    { bank: 'Big 4 Banks', rate: '8.5% - 12.5% p.a.', approval: '4-8 weeks', documentation: 'Extensive' },
    { bank: 'Regional Banks', rate: '9.0% - 13.0% p.a.', approval: '3-6 weeks', documentation: 'Comprehensive' },
    { bank: 'AAGT Private', rate: 'From 1.0% per month', approval: 'Same day', documentation: 'Minimal' }
  ];
  ...
  const loanProductSchema = {
    ...
    'description': 'Competitive private loan rates with transparent terms and flexible repayment options',
    'provider': {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              Competitive private loan rates with no hidden fees and flexible terms designed for your business needs
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our rates are competitive and transparent. All rates shown are indicative and subject to 
              individual assessment and loan approval.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              See how AAGT Private Loans compares to traditional banking options for business funding.
            </p>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white">
                {bankComparison.map((comparison, index) => (
                  <tr key={index} className={`border-b border-gray-200 ${comparison.bank === 'AAGT Private' ? 'bg-primary-50' : ''}`}>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              * Rates shown are indicative and subject to individual assessment. Traditional bank rates shown are annual percentage rates (APR).
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Flexible repayment options available including interest-only payments during the term. 
                  Principal and interest payments can be arranged to suit cash flow requirements.
                </p>
              </div>
      ...
      <section className="py-20 bg-primary-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Get a personalized rate quote based on your specific requirements. Our lending specialists 
            will work with you to find the most competitive terms for your situation.
          </p>
          <CallToAction />
        </div>
      </section>
