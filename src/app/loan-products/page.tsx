...
export const metadata: Metadata = {
  ...
  description: 'Explore our comprehensive range of business and investment loan products. From $150k to $5M with same-day approval. Business expansion, property investment, bridging finance and more.',
  keywords: 'business loans, investment loans, property finance, bridging loans, working capital, second mortgage, private lender Australia',
  openGraph: {
    title: 'Loan Products | AAGT Private Loans - Business & Investment Finance',
    description: 'Complete range of business and investment loan products from Australia\'s leading private lender. Fast approval, competitive rates, flexible terms.',
    type: 'website',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Complete range of business and investment loan products. Same-day approval, competitive rates.',
...
export default function LoanProductsPage() {
  ...
  const organizationSchema = {
    ...
    'description': 'Leading Australian private lender offering business and investment loans from $150,000 to $5,000,000',
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-primary-100 mb-8">
                From business expansion to investment properties, find the perfect funding solution for your needs
              </p>
