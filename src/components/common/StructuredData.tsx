...
export const generateOrganizationSchema = () => ({
  ...
  "alternateName": "AAGT",
  "description": "Direct private lending company providing business and investment loans from $150,000 to $5,000,000 with fast approvals and competitive rates.",
  ...
  "sameAs": [
    "https://linkedin.com/company/aagt-private-loans",
    "https://twitter.com/AAGTLoans"
  ],
...
export const generateLocalBusinessSchema = () => ({
  ...
  "name": "AAGT Private Loans",
  "description": "Leading private lending company in Australia specializing in business and investment loans.",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Level 1, 123 Business Street",
    "addressLocality": "Sydney",
