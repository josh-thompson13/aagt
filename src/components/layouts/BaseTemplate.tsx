              ...
              >
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <Link 
                      href="/apply" 
                      className="block w-full bg-primary-900 text-white text-center py-3 px-4 rounded-lg font-semibold hover:bg-primary-800 transition-colors duration-200"
                    >
                      Apply for Loan
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-gray-300">
                  <span className="font-medium text-white">Response Time:</span><br />
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-6 text-sm">
                ...
                <Link href="/compliance" className="text-gray-400 hover:text-teal-400 transition-colors duration-200">
                  Compliance
                </Link>
              </div>
            </div>
